...
//		c.as("rfVLQugNwsn4ToSBksFiQKTJphw2fU9W6Y", "snrnF2RiZWC7DRXQPykXdDHi1RgAb");
	...
	class MyThread extends Thread{
        ...
        public void run() {
    		...
    		c.event.subscribeTable("hijack", "rBuLBiHmssAMHWQMnEN7nXQXaVj7vhAv6Q", (data) -> {
...
//                printErr("{0}", sub.hash) );
	...
	public static  void testSignPayment(){
		...
		try{
			...
			//获取账户信息，得到当前Sequence
			AccountID account = AccountID.fromAddress(address.getString("address"));
			...
			tx_json.put("Account", address.getString("address"));
